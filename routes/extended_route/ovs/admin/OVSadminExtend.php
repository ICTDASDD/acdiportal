...
use App\Http\Controllers\ovs\admin\SystemLogController;
    ...
    Route::group(['middleware' => ['auth', 'role:ictd-admin']], function() {
        ...
        Route::POST('ovs/adm/candidatetype/list', [CandidateTypeController::class, 'listCandidateType'])->name('candidateType.list');
        ...
        Route::POST('ovs/adm/candidatelimit/list', [CandidateLimitController::class, 'listCandidateLimit'])->name('candidateLimit.list');
        ...
        Route::POST('ovs/adm/votingperiod/list', [VotingPeriodController::class, 'listVotingPeriod'])->name('votingPeriod.list');
        ...
        Route::POST('ovs/adm/candidatelist/list', [CandidateController::class, 'listCandidate'])->name('candidate.list');
        ...
        Route::POST('ovs/adm/amendmentlist/list', [AmendmentController::class, 'listAmendment'])->name('amendment.list');
      ...
      //  Route::get('ovs/adm/amendmentlist', [OVSAdminController::class, 'alist'])->name('OVSAdminAmendmentList');
        ...
        Route::POST('ovs/adm/request/list', [AdminRequestController::class, 'requestList'])->name('adm.request.list'); 
