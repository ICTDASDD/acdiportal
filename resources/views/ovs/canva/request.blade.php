                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="form-group">
                                        <select id="canvas_status" name="canvas_status" class="selectpicker" data-size="7" data-style="btn btn-primary btn-round btn-sm" title="Status">
...
$('#requestTable').on('click','.editRequest',function(){
  ...
  $.ajax({
      ...
      success: function (data) {
        ...
        $('#canvas_status').val(data.canvas_status);
...
$(document).on("click", "#btnUpdateRequest", function (e) {
  swal({
        ...
        $.ajax({
            type: "GET",
            url: "{{ route('canva.request.update') }}",
            data: { 
              id : id,
